...
#include "__data_sample_html_images_states_shit_svg_path99ba8b.h"

REGISTRY_WSJCPP_RESOURCE_FILE(RES___data_sample_html_images_states_shit_svg_path99ba8b)

const std::string &RES___data_sample_html_images_states_shit_svg_path99ba8b::getFilename() const {
  static const std::string s = "./data_sample/html/images/states/shit.svg";
  return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_html_images_states_shit_svg_path99ba8b::getPackAs() const {
  static const std::string s = "text";
  return s;
}
// ---------------------------------------------------------------------

int RES___data_sample_html_images_states_shit_svg_path99ba8b::getBufferSize() const {
  return 2770;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_html_images_states_shit_svg_path99ba8b::getBuffer() const {
