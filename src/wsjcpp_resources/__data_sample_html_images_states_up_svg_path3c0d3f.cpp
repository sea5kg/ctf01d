...
#include "__data_sample_html_images_states_up_svg_path3c0d3f.h"

REGISTRY_WSJCPP_RESOURCE_FILE(RES___data_sample_html_images_states_up_svg_path3c0d3f)

const std::string &RES___data_sample_html_images_states_up_svg_path3c0d3f::getFilename() const {
  static const std::string s = "./data_sample/html/images/states/up.svg";
  return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_html_images_states_up_svg_path3c0d3f::getPackAs() const {
  static const std::string s = "text";
  return s;
}
// ---------------------------------------------------------------------

int RES___data_sample_html_images_states_up_svg_path3c0d3f::getBufferSize() const {
  return 4172;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_html_images_states_up_svg_path3c0d3f::getBuffer() const {
