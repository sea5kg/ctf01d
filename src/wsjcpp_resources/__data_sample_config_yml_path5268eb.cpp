...
const char *RES___data_sample_config_yml_path5268eb::getBuffer() const {
  static const std::string sRet = "" // size: 8895
    ...
    "    big-logo: \"./html/images/services/service1-default-icon.svg\"\n"
    "    # host: 127.0.0.1\n"
    "    # port: 10001\n"
    ...
    "    big-logo: \"./html/images/services/service2-default-icon.svg\"\n"
    "    script_path: \"./checker.py\"\n"
    ...
    "    big-logo: \"./html/images/services/service3-default-icon.svg\"\n"
    "    script_path: \"./checker.py\"\n"
    "    script_wait_in_sec: 5\n"
    "    round_in_seconds: 15\n"
    ...
    "    big-logo: \"./html/images/services/service4-default-icon.svg\"\n"
    "    script_path: \"./checker.py\"\n"
    "    script_wait_in_sec: 5\n"
    "    round_in_seconds: 15\n"
    ...
    "    big-logo: \"./html/images/services/service5-default-icon.svg\"\n"
    "    script_path: \"./checker.py\"\n"
    "    script_wait_in_sec: 5\n"
    "    round_in_seconds: 15\n"
    ...
    "    big-logo: \"./html/images/services/service6-default-icon.svg\"\n"
    "    enabled: no\n"
    "    script_path: \"./checker.py\"\n"
    "    script_wait_in_sec: 5\n"
    "    round_in_seconds: 15\n"
    "\n"
    "# team.type can be normal, red, blue, guest, disqualified\n"
    "\n"
    "teams:\n"
    "  - id: \"t01\" # must be uniq\n"
    "    type: normal\n"
    ...
    "    ip-or-host: \"127.0.1.1\"\n"
    "  - id: \"t02\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #2\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team02.png\"\n"
    "    big-logo: \"./html/images/teams/team02.png\"\n"
    "    ip-or-host: \"127.0.2.1\"\n"
    "  - id: \"t03\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #3\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team03.png\"\n"
    "    big-logo: \"./html/images/teams/team03.png\"\n"
    "    ip-or-host: \"127.0.3.1\"\n"
    "  - id: \"t04\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #4\"\n"
    "    active: yes\n"
    ...
    "    big-logo: \"./html/images/teams/team03.png\"\n"
    "    ip-or-host: \"127.0.5.1\"\n"
    "  - id: \"t06\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #6\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team06.png\"\n"
    "    big-logo: \"./html/images/teams/team06.png\"\n"
    "    ip-or-host: \"127.0.6.1\"\n"
    "  - id: \"t07\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #7\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team07.png\"\n"
    "    big-logo: \"./html/images/teams/team07.png\"\n"
    "    ip-or-host: \"127.0.7.1\"\n"
    "  - id: \"t08\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #8\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team08.png\"\n"
    "    big-logo: \"./html/images/teams/team08.png\"\n"
    "    ip-or-host: \"127.0.8.1\"\n"
    "  - id: \"t09\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #9\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team09.png\"\n"
    "    big-logo: \"./html/images/teams/team09.png\"\n"
    "    ip-or-host: \"127.0.9.1\"\n"
    "  - id: \"t10\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #10\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team10.png\"\n"
    "    big-logo: \"./html/images/teams/team10.png\"\n"
    "    ip-or-host: \"127.0.10.1\"\n"
    "  - id: \"t11\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #11\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team11.png\"\n"
    "    big-logo: \"./html/images/teams/team11.png\"\n"
    "    ip-or-host: \"127.0.11.1\"\n"
    "  - id: \"t12\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #12\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team12.png\"\n"
    "    big-logo: \"./html/images/teams/team12.png\"\n"
    "    ip-or-host: \"127.0.12.1\"\n"
    "  - id: \"t13\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #13\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team13.png\"\n"
    "    big-logo: \"./html/images/teams/team13.png\"\n"
    "    ip-or-host: \"127.0.13.1\"\n"
    "  - id: \"t14\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #14\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team14.png\"\n"
    "    big-logo: \"./html/images/teams/team14.png\"\n"
    "    ip-or-host: \"127.0.14.1\"\n"
    "  - id: \"t15\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #15\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team15.png\"\n"
    "    big-logo: \"./html/images/teams/team15.png\"\n"
    "    ip-or-host: \"127.0.15.1\"\n"
    "  - id: \"t16\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #16\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team16.png\"\n"
    "    big-logo: \"./html/images/teams/team16.png\"\n"
    "    ip-or-host: \"127.0.16.1\"\n"
    "  - id: \"t17\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #17\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team17.png\"\n"
    "    big-logo: \"./html/images/teams/team17.png\"\n"
    "    ip-or-host: \"127.0.17.1\"\n"
    "  - id: \"t18\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #18\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team18.png\"\n"
    "    big-logo: \"./html/images/teams/team18.png\"\n"
    "    ip-or-host: \"127.0.18.1\"\n"
    "  - id: \"t19\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #19\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team19.png\"\n"
    "    big-logo: \"./html/images/teams/team19.png\"\n"
    "    ip-or-host: \"127.0.19.1\"\n"
    "  - id: \"t20\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #20\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team20.png\"\n"
    "    big-logo: \"./html/images/teams/team20.png\"\n"
    "    ip-or-host: \"127.0.20.1\"\n"
    "  - id: \"t21\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #21\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team21.png\"\n"
    "    big-logo: \"./html/images/teams/team21.png\"\n"
    "    ip-or-host: \"127.0.21.1\"\n"
    "  - id: \"t22\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #22\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team22.png\"\n"
    "    big-logo: \"./html/images/teams/team22.png\"\n"
    "    ip-or-host: \"127.0.22.1\"\n"
    "  - id: \"t23\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #23\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team23.png\"\n"
    "    big-logo: \"./html/images/teams/team23.png\"\n"
    "    ip-or-host: \"127.0.23.1\"\n"
    "  - id: \"t24\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #24\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team24.png\"\n"
    "    big-logo: \"./html/images/teams/team24.png\"\n"
    "    ip-or-host: \"127.0.24.1\"\n"
    "  - id: \"t25\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #25\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team25.png\"\n"
    "    big-logo: \"./html/images/teams/team25.png\"\n"
    "    ip-or-host: \"127.0.25.1\"\n"
    "  - id: \"t26\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #26\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team26.png\"\n"
    "    big-logo: \"./html/images/teams/team26.png\"\n"
    "    ip-or-host: \"127.0.26.1\"\n"
    "  - id: \"t27\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #27\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team27.png\"\n"
    "    big-logo: \"./html/images/teams/team27.png\"\n"
    "    ip-or-host: \"127.0.27.1\"\n"
    "  - id: \"t28\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #28\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team28.png\"\n"
    "    big-logo: \"./html/images/teams/team28.png\"\n"
    "    ip-or-host: \"127.0.28.1\"\n"
    "  - id: \"t29\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #29\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team29.png\"\n"
    "    big-logo: \"./html/images/teams/team29.png\"\n"
    "    ip-or-host: \"127.0.29.1\"\n"
    "  - id: \"t30\" # must be uniq\n"
    "    type: normal\n"
    "    name: \"Team #30 1111111111111111111111111111111\"\n"
    "    active: yes\n"
    "    logo: \"./html/images/teams/team30.png\"\n"
    "    big-logo: \"./html/images/teams/team30.png\"\n"
