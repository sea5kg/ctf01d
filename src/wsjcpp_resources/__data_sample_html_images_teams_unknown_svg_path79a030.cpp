...
#include "__data_sample_html_images_teams_unknown_svg_path79a030.h"

REGISTRY_WSJCPP_RESOURCE_FILE(RES___data_sample_html_images_teams_unknown_svg_path79a030)

const std::string &RES___data_sample_html_images_teams_unknown_svg_path79a030::getFilename() const {
  static const std::string s = "./data_sample/html/images/teams/unknown.svg";
  return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_html_images_teams_unknown_svg_path79a030::getPackAs() const {
  static const std::string s = "text";
  return s;
}
// ---------------------------------------------------------------------

int RES___data_sample_html_images_teams_unknown_svg_path79a030::getBufferSize() const {
  return 5633;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_html_images_teams_unknown_svg_path79a030::getBuffer() const {
