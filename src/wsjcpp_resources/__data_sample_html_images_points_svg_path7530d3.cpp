...
#include "__data_sample_html_images_points_svg_path7530d3.h"

REGISTRY_WSJCPP_RESOURCE_FILE(RES___data_sample_html_images_points_svg_path7530d3)

const std::string &RES___data_sample_html_images_points_svg_path7530d3::getFilename() const {
  static const std::string s = "./data_sample/html/images/points.svg";
  return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_html_images_points_svg_path7530d3::getPackAs() const {
  static const std::string s = "text";
  return s;
}
// ---------------------------------------------------------------------

int RES___data_sample_html_images_points_svg_path7530d3::getBufferSize() const {
  return 2979;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_html_images_points_svg_path7530d3::getBuffer() const {
