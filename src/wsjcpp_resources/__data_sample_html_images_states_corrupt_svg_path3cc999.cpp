...
#include "__data_sample_html_images_states_corrupt_svg_path3cc999.h"

REGISTRY_WSJCPP_RESOURCE_FILE(RES___data_sample_html_images_states_corrupt_svg_path3cc999)

const std::string &RES___data_sample_html_images_states_corrupt_svg_path3cc999::getFilename() const {
  static const std::string s = "./data_sample/html/images/states/corrupt.svg";
  return s;
}
// ---------------------------------------------------------------------

const std::string &RES___data_sample_html_images_states_corrupt_svg_path3cc999::getPackAs() const {
  static const std::string s = "text";
  return s;
}
// ---------------------------------------------------------------------

int RES___data_sample_html_images_states_corrupt_svg_path3cc999::getBufferSize() const {
  return 3462;
}

// ---------------------------------------------------------------------

const char *RES___data_sample_html_images_states_corrupt_svg_path3cc999::getBuffer() const {
